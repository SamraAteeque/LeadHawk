...
export default function Sidebar() {
  ...
  return (
    <aside className="sidebar-container" style={{
      ...
      {/* Header Bar */}
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }} className="sidebar-header-bar">
        {/* Logo */}
        ...
        >
          {isOpen ? (
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 4, width: 18 }}>
              <div style={{ height: 2, background: "#0F1117", width: "100%" }} />
              <div style={{ height: 2, background: "#0F1117", width: "100%" }} />
              <div style={{ height: 2, background: "#0F1117", width: "100%" }} />
            </div>
          )}
      ...
      {/* Navigation and other items (collapsed on mobile by default) */}
      <div className={`sidebar-content ${isOpen ? "open" : ""}`}>
        {/* Main nav */}
        <div style={{ padding: "0 12px", marginBottom: 8, marginTop: 16 }}>
        ...
        <div style={{ padding: "0 12px", marginBottom: 14 }}>
          <Link href="/settings" style={{ textDecoration: "none" }} onClick={() => setIsOpen(false)}>
            <div style={{
              display: "flex", alignItems: "center", gap: 10,
